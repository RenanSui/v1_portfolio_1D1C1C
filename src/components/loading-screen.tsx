...
const LoadingScreen = ({ setScreenState }: LoadingScreenProps) => {
  ...
  return (
    ...
    >
      ...
      <ShellAnimated className="fixed left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-1/2 select-none text-4xl font-bold tracking-widest text-nier-300 blur-[5px]">
