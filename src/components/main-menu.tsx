...
const MainMenu = () => {
  ...
  return (
    <ShellAnimated
      className={`flex h-full w-full flex-col bg-[linear-gradient(180deg,_hsla(231,_39%,_6%,_1)_0%,_hsla(222,_67%,_10%,_1)_59%,_hsla(206,_15%,_18%,_1)_83%,_hsla(105,_7%,_34%,_1)_100%)] font-medium tracking-[0.15em] ${RodinPro.className}`}
    >
      <StarsBackground />
