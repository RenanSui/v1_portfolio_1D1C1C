      ...
      {show && (
        <>
          <motion.div // z-50
            ...
            className="absolute bottom-0 left-0 right-0 top-0 z-50 bg-[rgba(0,0,0,0)] backdrop-blur-[1.2px]"
          />
          <motion.div
            animate={{
              backgroundColor: '#000',
          ...
          >
            <motion.h1
              ...
              className={`cursor-default select-none text-9xl font-bold text-nier-900 ${Concielian.className}`}
            >
              R
            </motion.h1>
            <motion.svg
