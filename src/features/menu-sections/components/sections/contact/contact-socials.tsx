        ...
        <Card key={`item-${item.id}`} className="hidden flex-1 md:flex">
          ...
          <CardContent>
            <CardImageLink className="relative" href={item.contactLink}>
              <item.icon className="pointer-events-none absolute left-1/2 top-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-nier-light-100 py-8" />
            </CardImageLink>
            ...
            <Card key={`item-${social.id}`} className="flex-1">
              ...
              <CardContent>
                <CardImageLink className="relative" href={social.contactLink}>
                  <item.icon className="absolute left-1/2 top-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-nier-light-100 py-8" />
                </CardImageLink>
                <CardSeparator className="mt-4" />
