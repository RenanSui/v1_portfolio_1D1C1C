...
export const MainMenu = () => {
  ...
  return (
    <AnimatedShell
      className={`relative z-40 flex h-full w-full flex-col overflow-hidden bg-[#01040F] bg-[linear-gradient(180deg,_hsla(227,_88%,_3%,_1)_30%,_hsla(222,_67%,_10%,_1)_67%,_hsla(100,_7%,_24%,_1)_100%)] font-medium tracking-[0.15em] blur-[0.5px]`}
    >
